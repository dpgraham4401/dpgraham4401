...
<template>
  <footer class="mt-16 mb-8">
    <Section class="mb-4">
      <div
        class="vim-border-b pb-4 flex flex-col sm:flex-row sm:flex-nowrap gap-8 sm:items-center"
      >
        ...
        <div class="flex flex-start items-start gap-4 w-full">
          <svg
            class="vim-fill w-8 h-8 min-h-8 min-w-8 max-h-8 max-w-8 -translate-y-2"
            height="32"
            viewBox="0 0 24 24"
            width="32"

<template>
  <button
    class="border-none bg-none focus:outline-2 focus:outline-offset-2 focus:outline-vim-dark dark:focus:outline-vim-light"
  ...
  >
    ...
    >
      <path
        class="transition-transform duration-150 ease-in-out  fill-neutral-900 dark:fill-transparent"
        fill-rule="evenodd"
      ...
      ></path>
      <path
        class="transition-transform duration-150 ease-in-out  fill-transparent dark:fill-neutral-100"
        fill-rule="evenodd"
...
/**
 * Initialize theme based on localStorage or system settings.
 */
